...
public class ToolExecutor {
  ...
  public init(mcpServers: [MCPServerConfig] = [], localToolsConfigPath: String? = nil, verbose: Bool = false, useStderr: Bool = false, showToolEventsVerbose: Bool = false) {
  ...
  public func registerLocalTool(_ tool: CLITool) {
