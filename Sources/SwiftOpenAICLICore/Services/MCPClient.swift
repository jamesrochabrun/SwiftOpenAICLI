...
public struct MCPServerConfig {
    ...
    public let transport: String  // "stdio" or "http"
    public let command: String?  // For stdio transport
    public let url: String?  // For http transport
    public let args: [String]
    public let environment: [String: String]?
    
    public init(name: String, transport: String, command: String? = nil, url: String? = nil, args: [String] = [], environment: [String: String]? = nil) {
        self.name = name
